...
function formatPricesForEarlyTimestamps(position) {
  ...
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    if (
      priceOverrides.includes(
        (_a = position === null || position === void 0 ? void 0 : position.pair) === null || _a === void 0
          ? void 0
          : _a.token0.id
      )
    ) {
    ...
    if (
      priceOverrides.includes(
        (_b = position === null || position === void 0 ? void 0 : position.pair) === null || _b === void 0
          ? void 0
          : _b.token1.id
      )
    ) {
    ...
    // WETH price
    if (
      ((_c = position.pair) === null || _c === void 0 ? void 0 : _c.token0.id) ===
      "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2"
    ) {
      position.token0PriceUSD = 203;
    }
    if (
      ((_d = position.pair) === null || _d === void 0 ? void 0 : _d.token1.id) ===
      "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2"
    ) {
...
export async function getHistoricalPairReturns(
  ...
  shareValues === null || shareValues === void 0
    ? void 0
...
export async function getLPReturnsOnPair(
  ...
  const currentPosition = {
    ...
    liquidityTokenBalance:
      (_a = snapshots[snapshots.length - 1]) === null || _a === void 0 ? void 0 : _a.liquidityTokenBalance,
